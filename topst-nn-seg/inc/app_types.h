...
#define APP_SEG_MAX_DET 16
#define APP_SEG_MASK_WIDTH 160
#define APP_SEG_MASK_HEIGHT 160
#define APP_SEG_MODEL_WIDTH 640
#define APP_SEG_MODEL_HEIGHT 640
...
typedef struct {
    ...
    float conf;
    int cls;
    uint8_t mask[APP_SEG_MASK_HEIGHT][APP_SEG_MASK_WIDTH];
} seg_obj_t;
